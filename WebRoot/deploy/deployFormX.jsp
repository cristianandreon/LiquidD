<html>
    ...
    <body>
        <center>            
            <table class="myForm">
                <tr>
                    <td colspan="2"><div class="titleDiv">WAR Deploy</div></td>
                </tr>
                <tr>
                    <td colspan="2" class="divider"></td>
                </tr>
                <tr>
                    <td><div class="leftDiv">Deploy configuration</div></td><td><div class="rightDiv"><input class="myInput" type="text" id="@{cfg}" /></div></td>
                </tr><tr>
                    <td><div class="leftDiv">War to deploy</div></td><td><div class="rightDiv"><input class="myFileInput" type="file" accept=".war" id="@{file}" /></div></td>
                </tr><tr>
