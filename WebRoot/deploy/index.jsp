...
<html>
    ...
    <body onload="onLoad(); startDeploysCfg(); startFormX(); ">
        ...
        <div id='menuXTop' style="position:relative; top:0px; left:0px; z-index: 100;" class="mainMenu liquidMenuX"></div>
        <div style="position:absolute; top:0px; right:50px; width: max-content; z-index:200" id="title" class="mainTitle">Liquid <span class="ver">v.1.x</span></div>
        <div id="feedbacksFrame" style="display:block" class="demoContent">
            <br/>
            <br/>
            <br/>
            <div class="title1">WAR Deploy</div>
