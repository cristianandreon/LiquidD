    ...
    public static Object do_deploy(Object deplpoyBean, String cfgName, String fileName, boolean doBackup, boolean askConfirmation, boolean openURL, boolean batchMode, HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            if (enabled) {
                ...
                String err = "The deploy '"+cfgName+"' was disabled";
                Messagebox.show(err, "LiquidD", Messagebox.WARNING + Messagebox.OK);
                Callback.send("Deploy skypped, <span style=\"color:orange\">" + err + "<span>");
                return (Object) "{ \"result\":-1, \"warning\":\"" + utility.base64Encode(err) + "\", \"client\":\"Liquid.stopWaiting('deploysCfg')\" }";
            }
